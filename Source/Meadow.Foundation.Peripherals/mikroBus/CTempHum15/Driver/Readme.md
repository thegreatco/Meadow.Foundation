...
The **CTempHum15** library is included in the **Meadow.Foundation.mikroBUS.Sensors.Atmospheric.CTempHum15** nuget package and is designed for the [Wilderness Labs](www.wildernesslabs.co) Meadow .NET IoT platform.
...
`dotnet add package Meadow.Foundation.mikroBUS.Sensors.Atmospheric.CTempHum15`
## Usage
